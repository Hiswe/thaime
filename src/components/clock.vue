...
import * as clockSegments from '~/utils/clock-segments'
  ...
  <div class="clock">
    <svg :viewBox="viewbox" class="clock-svg">
      ...
      <g class="clock-center" clip-path="url(#clip-clock)">
        <circle cx="0" cy="0" r="75" class="clock-center__day-sky"></circle>
        <path class="clock-center__night-sky" :d="nightSky"></path>
        <path
          class="clock-center__moon"
          d="M5,0.862c-2.284,0 -4.138,1.854 -4.138,4.138c0,2.284 1.854,4.138 4.138,4.138c-1.142,-0.69 -2.069,-2.306 -2.069,-4.138c0,-1.832 0.927,-3.448 2.069,-4.138Z"
        ></path>
        <g class="clock-center__stars">
          <path
            class="star"
            d="M5,0.914c0.622,0 1.009,3.106 1.009,3.106c0,0 3.073,-0.596 3.266,0c0.192,0.591 -2.642,1.92 -2.642,1.92c0,0 1.516,2.738 1.009,3.106c-0.503,0.365 -2.642,-1.92 -2.642,-1.92c0,0 -2.135,2.288 -2.642,1.92c-0.503,-0.365 1.009,-3.106 1.009,-3.106c0,0 -2.836,-1.324 -2.642,-1.92c0.192,-0.591 3.266,0 3.266,0c0,0 0.382,-3.106 1.009,-3.106Z"
          ></path>
          <path
            class="star"
            d="M5,0.914c0.622,0 1.009,3.106 1.009,3.106c0,0 3.073,-0.596 3.266,0c0.192,0.591 -2.642,1.92 -2.642,1.92c0,0 1.516,2.738 1.009,3.106c-0.503,0.365 -2.642,-1.92 -2.642,-1.92c0,0 -2.135,2.288 -2.642,1.92c-0.503,-0.365 1.009,-3.106 1.009,-3.106c0,0 -2.836,-1.324 -2.642,-1.92c0.192,-0.591 3.266,0 3.266,0c0,0 0.382,-3.106 1.009,-3.106Z"
        ...
        <g class="clock-center__sun">
          <path d="M5.769,0.68l0,8.64"></path>
          <path d="M10.004,5l-8.469,0"></path>
          <path d="M8.53,2.184l-5.521,5.632"></path>
          <path d="M8.41,7.693l-5.281,-5.386"></path>
          <ellipse cx="5.769" cy="5" rx="2.761" ry="2.816"></ellipse>
        </g>
        <circle cx="0" cy="0" r="75" class="clock-center__inner-ring"></circle>
      </g>
      ...
      <circle class="current-time" :cx="nowCoordinates.x" :cy="nowCoordinates.y" r="5"></circle>
      <g id="thai-hours">
        <text
          v-for="(marker) of hourMarkers"
          :key="`${marker.id}-th`"
      ...
      <g id="periods-name">
        ...
        <text
          ...
          text-anchor="middle"
        >
          <textPath :href="`#${periodName.pathId}`" startOffset="50%">
      ...
      <g id="interactive-shapes">
        ...
        ></path>
        <circle cx="0" cy="0" r="60" class="interactive-center" @click="$emit(`change`, false)"></circle>
      </g>
    </svg>
    <slot></slot>
  </div>
